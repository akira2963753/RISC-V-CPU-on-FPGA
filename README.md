# RISC-V-CPU
In the Spring of 2025, during my **Computer Organization course**, I learned how to implement a simple [**CPU Based on MIPS.**](https://github.com/akira2963753/MIPS-5-stage-pipelined-CPU)    
